								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												<span><?php echo $_SESSION ['kode_am'];?></span>
									...
									<li>
										...
										<a class="dropdown-item" href="<?=base_url('activity_am/profile?kode_am='.$kode_am)?>">My Profile</a>
										<a class="dropdown-item" href="<?=base_url('login/logout')?>" onclick="return confirm ('Sudah yakin ?')">Logout</a>
									</li>
								</div>
							</ul>
						</li>
